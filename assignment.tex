...
Op deze pagina kan een nieuwe gebruiker zichzelf registreren. Het aanmaken van een account kan door het geven van een gebruikersnaam een wachtwoord en dit wachtwoord te confirmeren via een extra textbox. Controlleer ook zeken of dat de gebruikersnaam uniek is. Voor het opslaan van het wachtwoord mag Pbkdf2 gebruikt worden als hash algoritme. \\
